robbables = {
    ...
    ["RT 68 Robs Liquor Cash Register 2"] = {
        name = "RT 68 Robs Liquor Cash Register 2",
        stockMoney = 300,
        maxMoney = 600,
        moneyRegen = 53, -- per minute
        type = 1
    },
    ["RT 68 Robs Liquor 24/7 Safe"] = {
        name = "RT 68 Robs Liquor 24/7 Safe",
        stockMoney = 700,
        maxMoney = 1200,
        moneyRegen = 53, -- per minute
        type = 2
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(robbables) do
			if(v.stockMoney<v.maxMoney)then
				v.stockMoney = v.stockMoney + v.moneyRegen
			end
		end
	end
end)
...
RegisterServerEvent("v_jobs:syncRobbery")
AddEventHandler("v_jobs:syncRobbery", function(spots)
	TriggerClientEvent("v_jobs:syncRobbery", -1, spots)
end)
